...
На стороне оператора установлено другое приложение( __Eshc_Office__ [ссылка для скачивания](https://github.com/steppeFisherman/Eshc_Office)) с базой данных всех клиентов для онлайн контроля текущих событий всех клиентов.
